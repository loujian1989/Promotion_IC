...
public class main_promotion_MSW_n50m2_alpha030 {

    public static void main(String[] args)throws Exception
    {
        Scanner cin=new Scanner(new File("SN_Scale_Free_n50m2.txt"));
        File writename = new File("PICSW_alpha_030_SN_Scale_Free_n50m2.txt");
