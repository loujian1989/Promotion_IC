...
public class main_promotion_MSW_n40m3_alpha020_41_60
{

    public static void main(String[] args)throws Exception
    {
        Scanner cin=new Scanner(new File("SN_Scale_Free_n40m3_41-60.txt"));
        File writename = new File("PICSW_alpha_020_SN_Scale_Free_n40m3_41-60.txt");
