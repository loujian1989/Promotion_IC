...
public class main_promotion_MSW_n40m3_alpha025 {

    public static void main(String[] args)throws Exception
    {
        Scanner cin=new Scanner(new File("SN_Scale_Free_n40m3.txt"));
        File writename = new File("PICSW_alpha_025_SN_Scale_Free_n40m3.txt");
