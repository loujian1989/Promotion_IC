...
public class main_promotion_MSW_n40m3_alpha010_61_80
{

    public static void main(String[] args)throws Exception
    {
        Scanner cin=new Scanner(new File("SN_Scale_Free_n40m3_61-80.txt"));
        File writename = new File("PICSW_alpha_010_SN_Scale_Free_n40m3_61-80.txt");
