...
public class main_promotion_MSW_n40m2_alpha000 {

    public static void main(String[] args)throws Exception
    {
        Scanner cin=new Scanner(new File("SN_Scale_Free_n40m2.txt"));
        File writename = new File("PICSW_alpha_000_SN_Scale_Free_n40m2.txt");
