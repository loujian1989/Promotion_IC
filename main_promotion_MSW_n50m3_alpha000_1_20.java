...
public class main_promotion_MSW_n50m3_alpha000_1_20
{

    public static void main(String[] args)throws Exception
    {
        Scanner cin=new Scanner(new File("SN_Scale_Free_n50m3_1-20.txt"));
        File writename = new File("PICSW_alpha_000_SN_Scale_Free_n50m3_1-20.txt");
