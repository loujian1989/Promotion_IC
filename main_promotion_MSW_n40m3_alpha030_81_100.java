...
public class main_promotion_MSW_n40m3_alpha030_81_100
{

    public static void main(String[] args)throws Exception
    {
        Scanner cin=new Scanner(new File("SN_Scale_Free_n40m3_81-100.txt"));
        File writename = new File("PICSW_alpha_030_SN_Scale_Free_n40m3_81-100.txt");
